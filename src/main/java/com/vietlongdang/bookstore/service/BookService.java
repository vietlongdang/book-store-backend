...
import com.vietlongdang.bookstore.entity.Checkout;
import com.vietlongdang.bookstore.responseModels.ShelfCurrentLoansResponse;
...
public class BookService {
    ...
    public int currentLoansCount(String userEmail) {return checkoutRepository.findBooksByUserEmail(userEmail).size();}
